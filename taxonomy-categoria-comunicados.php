...
<section>
    <div class="inner-continer-page">
        ...
        <div class="main-container"  id="noticias_list">
                    <p class="breadcumbs"><a class="breadcumbsLink" href="<?php echo get_home_url(); ?>">Inicio</a> <i class="fa fa-angle-double-right" aria-hidden="true"></i> <a class="breadcumbsLink" href="#">Comunicados</a></p>
            		<h1><?php _e( 'Noticias de ', 'comunicados' ); single_cat_title(); ?></h1>
					...
					<div class="news-card aTable-m">
            			<div class="aA-300"><img src="<?php the_field('foto_miniatura', get_the_ID()); ?>" alt=""></div>
